...
<template>
    <div class="container mx-auto mt-10 mb-10">
        ...
        <!--Contenedor criticas-->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-10 mb-15 justify-center bg-flamingo text-white rounded lg:divide-x md:divide-x divide-y">
            <!--Criticas-->
            <div class="pl-10">
                <!--Titulo-->
                ...
                <button class="mt-5 m-auto text-flamingo bg-white hover:text-black focus:bg-white focus:ring-flamingo focus:text-flamingo focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5">
                ...
                <form>
                    <div class="w-[70%] m-auto mt-4 mb-4 rounded-lg bg-gray-300">
                        <div class="px-4 py-2 bg-gray-300 rounded-t-lg">
                            ...
                            <textarea id="comment" rows="4" class="w-full px-0 text-sm text-gray-900 bg-gray-300 border-0 focus:ring-red-400 focus:border-red-400" placeholder="Escribe tu valoración..." required></textarea>
                            <!--Parte de nota-->
                            <select name="nota" class="bg-gray-50 border border-gray-300 text-gray-900 text-base focus:ring-red-400 focus:border-red-400 block w-full p-2.5">
                        ...
                        <div class="flex items-center justify-between px-3 py-2 border-t">
                            <button type="submit" class="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-flamingo rounded-lg focus:ring-4 focus:ring-flamingo hover:bg-flamingo hover:text-black">
                                Enviar valoración
                            </button>
                        </div>
                    </div>
