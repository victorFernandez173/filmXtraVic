            ...
            <div class="pl-10">
                ...
                <ul>
                    ...
                    <li class="list-disc ml-5"><span class="underline font-semibold">Irene:</span> Es mi película favorita (18/05/2023) - Likes: 32
                        <!--Mano abajo-->
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5 ml-5 mr-5 inline-block">
                ...
                <button class="mt-5 m-auto text-black bg-white hover:text-flamingo focus:bg-white focus:ring-flamingo focus:text-flamingo focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5">
